...
import ${packageName}.${subPackageName}.portal.sys.biz.AreaService;
...
import ${packageName}.${subPackageName}.portal.sys.vo.output.AreaDescOut;
import ${packageName}.${subPackageName}.portal.sys.vo.output.AreaListOut;
