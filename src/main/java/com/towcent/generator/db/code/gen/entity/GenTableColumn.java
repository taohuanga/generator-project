package com.towcent.generator.db.code.gen.entity;

import java.util.List;

import com.google.common.collect.Lists;
import com.towcent.generator.db.code.gen.base.BaseEntity;
...
public class GenTableColumn extends BaseEntity<GenTableColumn> {
	...
	private String simpleJavaType;  // 简写Java类型
	private String dxJavaField; // Java字段名首字母大写
	private String upperName;   // 列名大写
	...
	public String getDxJavaField() {
		return dxJavaField;
	}

	public void setDxJavaField(String dxJavaField) {
		this.dxJavaField = dxJavaField;
	}
